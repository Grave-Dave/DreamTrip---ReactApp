	...
	return (
		<div className='trip-box__item'>
			<h3 className='trip-box-text'>
				{`Trip: ${trip.formData.tripName && trip.formData.tripName.length ? trip.formData.tripName : trip.number}`}{' '}
				<i
					onClick={() => {
						removeTripItems(trip.number);
					}}
			...
			<div className='trip-info'>
				...
				<div className='trip-details'>
					<h4>
						Destination: <span>{trip.formData.direction}</span>
					</h4>
